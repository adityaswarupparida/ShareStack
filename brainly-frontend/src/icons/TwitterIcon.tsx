...
export const TwitterIcon = (props: IconProps) => {
    return <div>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" id="Twitter-Logo-1--Streamline-Logos" height="24" width="24" className={iconSizeVariants[props.size]}><desc>Twitter Logo 1 Streamline Icon: https://streamlinehq.com</desc>
        <path stroke="#000000" stroke-linecap="round" stroke-linejoin="round" d="M1.5 19c16 4.4 19.127 -5.275 19 -10.5 1.21 -0.33 1.833 -1.333 2 -2 -0.8 0.4 -1.667 0.167 -2 0 1.2 -0.4 1.124 -1.597 1 -2.5 -0.503 0.264 -1.435 0.916 -2.5 1 -0.712 -1.113 -2.5 -2 -5 -1s-3 3.667 -2.5 5C8.3 9 4.5 5.667 3 4c-1.798 2.565 0.477 5.11 1.5 6 -0.682 0.204 -1.5 0 -2 -0.5 0 2.855 2.5 4 3.5 4.5H4c0 2 2.333 2.833 3.5 3 -0.8 0.8 -4.333 1.667 -6 2Z" stroke-width="1"></path></svg>
    </div>
}